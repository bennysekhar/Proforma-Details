	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'Proforma_details' => ['Person details', '', 'table.gif', 'None'],
		];
			...
			$schema = [
				'Proforma_details' => [
					'field1' => [
						...
						'info' => [
							'caption' => 'Name',
							'description' => 'Full name of the person (Surname, First Name, Middle Name)',
						],
					],
					'Address' => [
						...
						'info' => [
							'caption' => 'Address',
							'description' => 'Location details of the Applicant',
						],
					],
					'Mobile' => [
						'appgini' => "SMALLINT(10) NOT NULL",
						'info' => [
							'caption' => 'Mobile',
							'description' => 'Primary contact with applicant.',
						],
					],
					'Email' => [
						...
						'info' => [
							'caption' => 'Email',
							'description' => 'Secondary contact with applicant.',
						],
					],
					'Date_Of_Birth' => [
						'appgini' => "DATE NULL",
