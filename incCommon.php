<?php
	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			'Proforma_details' => "`Proforma_details`.`field1` as 'field1', `Proforma_details`.`Address` as 'Address', `Proforma_details`.`Mobile` as 'Mobile', `Proforma_details`.`Email` as 'Email', if(`Proforma_details`.`Date_Of_Birth`,date_format(`Proforma_details`.`Date_Of_Birth`,'%m/%d/%Y'),'') as 'Date_Of_Birth'",
		];
